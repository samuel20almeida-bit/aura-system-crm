...
**O que só o Samuel/Saymon podem fazer:** abrir um negócio no Pipeline, editar um campo da conta ou o próximo passo, e conferir que "salvando…" aparece e depois "salvo" — sem clicar em nada — e que fechar a gaveta rápido demais depois de digitar não perde a edição (é exatamente o que o teste "edição durante um save em voo" da Task 1 garante em teoria; só um teste manual confirma na prática).
