    ...
    <div className="relative flex">
      ...
      {open && (
        <>
          ...
          <div className="fixed inset-x-2 top-14 z-50 overflow-hidden rounded-card border border-border bg-surface shadow-layer animate-fade-in md:absolute md:inset-x-auto md:right-0 md:top-7 md:w-80">
